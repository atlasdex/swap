    ...
    <AccountStyle>
      ...
      <Flex className="row m-0 account-btn-row">
        ...
        <Flex className="col-12 col-lg-4  text-center py-2 cursor-pointer">
          ...
          >
            <path
              d="M5.9502 5.24268L10.1928 1.00004L14.4355 5.24268"
              stroke={isDark ? colors.white : colors.primary}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M10.1923 15.1421L5.94967 19.3847L1.70703 15.1421"
              stroke={isDark ? colors.white : colors.primary}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
